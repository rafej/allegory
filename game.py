				...
				if phone3 == "y":
					...
					if phone2 == 2:
						...
						if reply1 == 1:
							...
							if messege1 == 1:
								print "You replied with: ", "\n","Babe, I'm so sorry. Please forgive me! :)"
								print "You wait 2 mins and 3 seconds for a response"
								print "Ding, ding"
								print "(Messenger) (1) Bella messaged you"
								print "Bella said: Mate, it doesn't work like that!"
								reply2 = str(raw_input("Do you want to reply?(y/n): "))
		...
		if phone2 == 2:
			...
			if reply1 == 1:
				...
				if messege1 == 1:
					...
					reply2 = str(raw_input("Do you want to reply?(y/n): "))
					if reply2 == "n":
						print "You put down your phone and stare into the light peering out of your window momentarily"
						getUp = str(raw_input("Do you want to get out of bed?:(y/n) "))
						if getUp == "y":
							print "You got up"
							print "Slowly but surely, your body aches out of bed"
